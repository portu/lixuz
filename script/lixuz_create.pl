...
Catalyst::ScriptRunner->run('LIXUZ', 'Create');

1;

=head1 NAME

lixuz_create.pl - Create a new Catalyst Component

=head1 SYNOPSIS

lixuz_create.pl [options] model|view|controller name [helper] [options]
